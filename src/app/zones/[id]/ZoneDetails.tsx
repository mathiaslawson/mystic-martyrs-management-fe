...
const ZoneDetail = ({ data }: { data: ZoneData }) => {
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    ...
    updateDetails({
      ...
      zone_location:
        editData.zone_location || details?.data?.data?.zone_location,
    });
  };
    ...
    <div className="min-h-screen xl:mt-[-0.5rem] mt-10">
      <div className="max-w-7xl mx-auto">
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Make changes to the zone here. Click save when you&rsquo;re
                    done.
                  </DialogDescription>
                </DialogHeader>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    the zone and all associated data.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                  <Button
        ...
        <div className="grid gap-8 lg:grid-cols-3 mb-8">
            ...
            <CardContent className="mt-4">
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Badge
                    variant="secondary"
                    className="bg-purple-100 text-yellow-800 px-3 py-1 rounded-full"
                  >
                    {zoneData.zone_name}
                  </Badge>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 lg:col-span-3">
            ...
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>Fellowship Leader Name</TableHead>
                ...
                <TableBody>
                  {zoneData.leaders.map(
                    (leaders: {
                      ...
                      <TableRow key={leaders.member.zone_id}>
                 ...
                 <div className="text-center text-neutral-500 mt-10 text-sm">
                    {zoneData.leaders.length === 0 && "No Fellowships Leaders"}
                </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 lg:col-span-3">
            <CardHeader className="bg-yellow-100 text-black rounded-t-lg">
              <CardTitle>Associate Fellowships</CardTitle>
              <CardDescription className="text-yellow-900">
                Fellowships in this zone
              </CardDescription>
              <div className="border-yellow-600 mt-3 bg-gradient-to-r from-yellow-500 to-yellow-700 shadow-lg w-full h-2 rounded-full"></div>
            ...
            <CardContent>
              ...
              <div className="text-center text-neutral-500 mt-10 text-sm">
                    {zoneData.fellowships.length === 0 && "No Fellowships"}
                </div>
            </CardContent>
          </Card>
        </div>
