...
const FellowshipDetails = ({
  ...
  } = useAction(getFellowshipByID);
  const {
    execute: updateDetails,
    isExecuting: isUpdating,
    result: updateResult,
  } = useAction(updateFellowship);
  const {
    execute: deleteDetails,
    isExecuting: isDeleting,
    result: deleteResult,
  } = useAction(deleteFellowship);
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    ...
    updateDetails({
      ...
      fellowship_name:
        editData.fellowship_name || details?.data?.data?.fellowship_name,
    });
  };
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Make changes to the Fellowship here. Click save when
                    you&rsquo;re done.
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Input
                        id="fellowship_name"
                        value={
                          editData.fellowship_name ||
                          fellowshipData.fellowship_name
                        }
                        onChange={(e) =>
                          setEditData({
                            ...editData,
                            fellowship_name: e.target.value,
                          })
                        }
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    fellowship the fellowship and all associated data.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                  <Button
        ...
        <div className="grid gap-8 lg:grid-cols-3 mb-8">
            ...
            <CardContent className="mt-4">
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Badge
                    variant="secondary"
                    className="bg-purple-100 text-red-800 px-3 py-1 rounded-full"
                  >
                    {fellowshipData.fellowship_name}
                  </Badge>
                  <span className="text-sm text-gray-500">
                    ID: {fellowshipData.fellowship_id}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>
                    Created on {formatDate(fellowshipData.created_at)}
                  </span>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-white overflow-hidden hover:shadow-lg transition-all duration-300 group lg:col-span-1">
            <CardHeader className="text-black rounded-t-lg bg-red-100">
              <CardTitle>Associate Zone</CardTitle>
              <CardDescription className="text-red-900">
Zone Associated with Fellowship
              </CardDescription>
              <div className="border-red-600 mt-3 bg-gradient-to-r from-red-500 to-red-700 shadow-lg w-full h-2 rounded-full"></div>
            </CardHeader>
            <CardContent className="mt-4">
          ...
          <Card className="bg-white overflow-hidden hover:shadow-lg transition-all duration-300 group lg:col-span-3">
            <CardHeader className="bg-red-100 text-black rounded-t-lg">
              <CardTitle>Fellowship Leaders</CardTitle>
              <CardDescription className="text-red-900">
               Leaders heading this fellowship
              </CardDescription>
              <div className="border-red-600 mt-3 bg-gradient-to-r from-red-500 to-red-700 shadow-lg w-full h-2 rounded-full"></div>
            </CardHeader>
            <CardContent>
...
{/* cells */}
          <Card className="bg-white overflow-hidden hover:shadow-lg transition-all duration-300 group lg:col-span-3">
            <CardHeader className="bg-red-100 text-black rounded-t-lg">
              <CardTitle>Associate Cells</CardTitle>
              <CardDescription className="text-red-900">
                Cells associated with this fellowship
              </CardDescription>
              <div className="border-red-600 mt-3 bg-gradient-to-r from-red-500 to-red-700 shadow-lg w-full h-2 rounded-full"></div>
            </CardHeader>
            <CardContent>
                  ...
                  {fellowshipData.cells?.map(
                    (fellowship: {
                      ...
                      <TableRow key={fellowship.cell_id}>
                        <TableCell className="font-medium">
                          {fellowship.cell_name}
                        </TableCell>
                        <TableCell>
                          {formatDate(fellowship.created_at)}
                        </TableCell>
                      </TableRow>
                    )
                  )}
