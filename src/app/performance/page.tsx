...
function PerformanceAnalytics() {
  ...
  }, [startDate, endDate, getFullCellPerformance])
  ...
  return (
    <div className="xl:mt-[-1.6rem] mt-10">
      <div className="flex flex-col space-y-6">
        {/* Header */}
        <div className="border-purple-600 bg-gradient-to-r from-purple-500 to-purple-700 rounded-md p-4 shadow-lg">
          <div className="flex items-center justify-between h-[15svh]">
            <div className="flex items-center space-x-4 text-purple-200">
              <div>
                ...
                <p className="text-neutral-200 mt-2">A curated performance distribution of the family&apos;s performance in terms of attendance and examinations </p>
              </div>
            </div>
...
export default withAuth(PerformanceAnalytics)
